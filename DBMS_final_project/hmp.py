...
#                     Train.No_of_seats,
#                     GetJourneyDuration(T1.Departure_time, T2.Arrival_time) AS journey_duration
#                 FROM Timing T1
...
#     cancel_button = tk.Button(homepage, text="Cancel Ticket", font=("Arial", 14), bg="white", fg="#27ae60", width=15, command=cancel_ticket_prompt)
#     cancel_button.place(relx=1.0, rely=1.0, anchor='se', x=-10, y=-10)
...
#     )
#     view_journey_button.pack(side="left", padx=10, pady=10)  # Align to the left inside the bottom frame
